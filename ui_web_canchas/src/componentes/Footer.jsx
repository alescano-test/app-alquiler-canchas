...
export const Footer = () => {
    ...
    return(
        <>
            <footer className="footer p-10 bg-verde-oscuro text-base-content font-base">
                <aside>
                    ...
                    <p>CanchasGo!<br/> AppWeb - TP final Laboratorio IV - 2023</p>
                </aside>
                <nav>
                    <header className="footer-title">Equipo</header> 
                    {links_equipo.map(link => (
                        <a href ="/" className="link link-hover">{link}</a>
                    ))}
